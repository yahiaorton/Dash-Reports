...
def build_query(table_name, params_dict: dict):
    if table_name == Tables.Military:
        return build_millitary_query(
            Str_ID=params_dict.get("Str_ID", None),
            Org_IDs=params_dict.get("Org_IDs", None),
            Company_ID=params_dict.get("Company_ID", None),
            Person_Inst_IDs=params_dict.get("Person_Inst_IDs", None),
            Org_Type=params_dict.get("Org_Type", None),
            Business_Entity_ID=params_dict.get("Business_Entity_ID", None),
            WithChilds=params_dict.get("WithChilds", 0),
            Military_Status=params_dict.get("Military_Status", None),
            Financial_Company_IDs=params_dict.get("Financial_Company_IDs", None),
        )
    elif table_name == Tables.Custodies:
        return build_custodies_query(
            Str_ID=params_dict.get("Str_ID", None),
            Org_IDs=params_dict.get("Org_IDs", None),
            Company_ID=params_dict.get("Company_ID", None),
            Person_Inst_IDs=params_dict.get("Person_Inst_IDs", None),
            ...
            Business_Entity_ID=params_dict.get("Business_Entity_ID", None),
            WithChilds=params_dict.get("WithChilds", 0),
            Employee_Status=params_dict.get("Employee_Status", None),
            Financial_Company_IDs=params_dict.get("Financial_Company_IDs", None),
            Custody_IDs=params_dict.get("Custody_IDs", None),
        )
